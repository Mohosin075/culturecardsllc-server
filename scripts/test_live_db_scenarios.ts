...
import {
  LiveStream,
  AuctionItem,
} from '../src/app/modules/auction/auction.model'
...
const runLiveDatabaseScenarios = async () => {
  ...
  console.log(
    colors.cyan('🚀 CULTURE CARDS LLC - LIVE SCENARIO INTEGRATION TEST'),
  )
  console.log(
    colors.cyan('==================================================\n'),
  )
  ...
  if (!dbUrl) {
    console.log(
      colors.red('✖ DATABASE_URL is missing in environment variables.'),
    )
    return
  }
  ...
  try {
    ...
    console.log(
      colors.yellow(
        'Step 2: Onboarding collectible items into product catalog...',
      ),
    )
    ...
    console.log(
      colors.green(`✔ Product A (Pikachu) Created: ID ${productA._id}`),
    )
    ...
    console.log(
      colors.green(`✔ Product B (Charizard) Created: ID ${productB._id}\n`),
    )

    // --- SCENARIO A: LIVE AUCTION STREAM & SECURE CONCURRENT BIDDING ---
    console.log(
      colors.yellow(
        'Step 3: Simulating live broadcast and concurrent bid race...',
      ),
    )
    ...
    console.log(
      colors.green(
        `✔ Agora stream started on channel: "${stream.agoraChannelName}"`,
      ),
    )
    ...
    console.log(
      colors.green(
        `✔ Auction item registered. Current Bid: $${auctionItem.currentBid}`,
      ),
    )
    ...
    console.log(
      colors.green(
        `   ✔ Bid registered! New Bid: $${updatedAuction1.currentBid}`,
      ),
    )
    console.log(
      colors.green(
        `   ✔ Anti-Sniping triggered: Auction end time extended to: ${updatedAuction1.endsAt}\n`,
      ),
    )
    ...
    console.log(
      colors.yellow(
        'Step 4: Proposing barter trade exchange with cash supplement...',
      ),
    )
    ...
    console.log(
      colors.green(
        `✔ Trade proposal created. Proposed swap Charizard for Pikachu + $250,000 cash.`,
      ),
    )
    ...
    console.log(
      colors.green(
        `   ✔ Escrow Hold Active. Pikachu status: "${finalProductA?.status}"`,
      ),
    )
    console.log(
      colors.green(
        `   ✔ Escrow Hold Active. Charizard status: "${finalProductB?.status}"\n`,
      ),
    )
    ...
    console.log(
      colors.yellow(
        'Step 5: Simulating Buy Now checkout and order creation...',
      ),
    )
    ...
    console.log(
      colors.green(
        `✔ Order checked out successfully! Total Paid: $${order.amountDetails.totalPaid}`,
      ),
    )
    ...
    console.log(
      colors.green('   ✔ Live transit update published successfully!'),
    )
    console.log(
      colors.green(
        `   ↳ Package location: "${updatedOrder.trackingDetails.journeyUpdates[1].description}"`,
      ),
    )
    console.log(
      colors.green(
        '   ↳ Automated chat updates card and FCM Push Notification triggered!\n',
      ),
    )
    ...
    console.log(
      colors.green('🎉 END-TO-END SCENARIO RUN COMPLETED SUCCESSFULLY!'),
    )
    console.log(
      colors.cyan('=================================================='),
    )
