...
const updateReview = (0, catchAsync_1.default)(async (req, res) => {
  const { id } = req.params
  const reviewData = req.body
  const result = await review_service_1.ReviewServices.updateReview(
    req.user,
    id,
    reviewData,
  )
...
const getAllReviews = (0, catchAsync_1.default)(async (req, res) => {
  ...
  const result = await review_service_1.ReviewServices.getAllReviews(
    type,
    paginationOptions,
  )
  ;(0, sendResponse_1.default)(res, {
...
const getReviewsByBooking = (0, catchAsync_1.default)(async (req, res) => {
  ...
  const result = await review_service_1.ReviewServices.getReviewsByBooking(
    req.user,
...
const getReviewsByProvider = (0, catchAsync_1.default)(async (req, res) => {
  ...
  const result = await review_service_1.ReviewServices.getReviewsByProvider(
...
const deleteReview = (0, catchAsync_1.default)(async (req, res) => {
  const { id } = req.params
  const result = await review_service_1.ReviewServices.deleteReview(
    id,
    req.user,
  )
  ;(0, sendResponse_1.default)(res, {
...
const getSingleReview = (0, catchAsync_1.default)(async (req, res) => {
  const { id } = req.params
  const result = await review_service_1.ReviewServices.getSingleReview(
    id,
    req.user,
  )
  ;(0, sendResponse_1.default)(res, {
