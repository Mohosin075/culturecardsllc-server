...
const createCheckoutSession = (0, catchAsync_1.default)(async (req, res) => {
  const user = req.user
  const result = await payment_service_1.PaymentServices.createCheckoutSession(
    user,
    req.body,
  )
...
const verifyCheckoutSession = (0, catchAsync_1.default)(async (req, res) => {
  ...
  const result =
    await payment_service_1.PaymentServices.verifyCheckoutSession(sessionId)
  ;(0, sendResponse_1.default)(res, {
...
const getAllPayments = (0, catchAsync_1.default)(async (req, res) => {
  ...
  const result = await payment_service_1.PaymentServices.getAllPayments(
    user,
    filters,
    paginationOptions,
  )
...
const updatePayment = (0, catchAsync_1.default)(async (req, res) => {
  const { id } = req.params
  const result = await payment_service_1.PaymentServices.updatePayment(
    id,
    req.body,
  )
  ;(0, sendResponse_1.default)(res, {
...
const refundPayment = (0, catchAsync_1.default)(async (req, res) => {
  ...
  const result = await payment_service_1.PaymentServices.refundPayment(
    id,
    reason,
  )
  ;(0, sendResponse_1.default)(res, {
...
const createPaymentIntent = (0, catchAsync_1.default)(async (req, res) => {
  const user = req.user
  const result = await payment_service_1.PaymentServices.createPaymentIntent(
    user,
    req.body,
  )
  ;(0, sendResponse_1.default)(res, {
...
const createEphemeralKey = (0, catchAsync_1.default)(async (req, res) => {
  ...
  const result = await payment_service_1.PaymentServices.createEphemeralKey(
    user,
    apiVersion,
  )
  ;(0, sendResponse_1.default)(res, {
...
const getMyPayments = (0, catchAsync_1.default)(async (req, res) => {
  ...
  const result = await payment_service_1.PaymentServices.getMyPayments(
    user,
    paginationOptions,
  )
  ;(0, sendResponse_1.default)(res, {
...
const getMyPaymentMethods = (0, catchAsync_1.default)(async (req, res) => {
  const user = req.user
  const result =
    await payment_service_1.PaymentServices.getMyPaymentMethods(user)
  ;(0, sendResponse_1.default)(res, {
    statusCode: http_status_codes_1.StatusCodes.OK,
    success: true,
...
const deletePaymentMethod = (0, catchAsync_1.default)(async (req, res) => {
  const user = req.user
  const { id } = req.params
  const result = await payment_service_1.PaymentServices.deletePaymentMethod(
    user,
    id,
  )
  ;(0, sendResponse_1.default)(res, {
...
const setDefaultPaymentMethod = (0, catchAsync_1.default)(async (req, res) => {
  ...
  const { id } = req.params
  const result =
    await payment_service_1.PaymentServices.setDefaultPaymentMethod(user, id)
  ;(0, sendResponse_1.default)(res, {
    statusCode: http_status_codes_1.StatusCodes.OK,
    success: true,
