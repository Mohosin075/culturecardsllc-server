...
class DashboardService {
  ...
  async getOverviewData() {
    ...
    try {
      ...
      const totalRevenue =
        ((_a = revenueResult[0]) === null || _a === void 0
          ? void 0
          : _a.total) || 0
      ...
      const recentOrders = recentOrdersRaw.map(o => {
        ...
        return {
          ...
          title:
            ((_a = o.productId) === null || _a === void 0
              ? void 0
              : _a.title) || 'Unknown Product',
          buyer:
            ((_b = o.buyerId) === null || _b === void 0
              ? void 0
              : _b.fullName) ||
            ((_c = o.buyerId) === null || _c === void 0 ? void 0 : _c.name) ||
            'Unknown Buyer',
          amount:
            ((_d = o.amountDetails) === null || _d === void 0
              ? void 0
              : _d.totalPaid) || 0,
      ...
      const recentTrades = recentTradesRaw.map(t => {
        ...
        return {
          ...
          sender:
            ((_c = t.senderId) === null || _c === void 0
              ? void 0
              : _c.fullName) ||
            ((_d = t.senderId) === null || _d === void 0 ? void 0 : _d.name) ||
            'Sender',
          receiver:
            ((_e = t.receiverId) === null || _e === void 0
              ? void 0
              : _e.fullName) ||
            ((_f = t.receiverId) === null || _f === void 0
              ? void 0
              : _f.name) ||
            'Receiver',
      ...
      const flaggedActivities = recentSupportsRaw.map(s => {
        ...
        return {
          username:
            ((_a = s.reportedUser) === null || _a === void 0
              ? void 0
              : _a.fullName) ||
            ((_b = s.reportedUser) === null || _b === void 0
              ? void 0
              : _b.name) ||
            ((_c = s.userId) === null || _c === void 0
              ? void 0
              : _c.fullName) ||
    ...
    try {
      ...
      const result = await Promise.all(
        users.map(async (u, idx) => {
          ...
          if (
            u.roles.includes(user_1.USER_ROLES.PROFESSIONAL) &&
          ...
          return {
            ...
            status:
              u.status === user_1.USER_STATUS.ACTIVE ? 'Active' : 'Suspended',
          }
        }),
      )
  ...
  async getListingsData(query) {
    try {
      const totalProductsDbCount =
        await product_model_1.Product.countDocuments()
      ...
      const result = products.map((p, idx) => {
        ...
        return {
          ...
          seller:
            ((_a = p.sellerId) === null || _a === void 0
              ? void 0
              : _a.fullName) ||
            ((_b = p.sellerId) === null || _b === void 0 ? void 0 : _b.name) ||
            'Seller',
  ...
  async getLiveStreamsData(query) {
    try {
      const [liveStreams, scheduledStreams] = await Promise.all([
        auction_model_1.LiveStream.find({ status: 'live' }).populate(
          'sellerId',
          'name fullName',
        ),
        auction_model_1.LiveStream.find({ status: 'scheduled' }).populate(
          'sellerId',
          'name fullName',
        ),
      ])
      const currentlyLive = liveStreams.map(s => {
        ...
        return {
          ...
          seller:
            ((_a = s.sellerId) === null || _a === void 0
              ? void 0
              : _a.fullName) ||
            ((_b = s.sellerId) === null || _b === void 0 ? void 0 : _b.name) ||
            'Seller',
    ...
    try {
      ...
      const result = trades.map((t, idx) => {
        ...
        return {
          ...
          userA:
            ((_a = t.senderId) === null || _a === void 0
              ? void 0
              : _a.fullName) ||
            ((_b = t.senderId) === null || _b === void 0 ? void 0 : _b.name) ||
            'User A',
          userB:
            ((_c = t.receiverId) === null || _c === void 0
              ? void 0
              : _c.fullName) ||
            ((_d = t.receiverId) === null || _d === void 0
              ? void 0
              : _d.name) ||
            'User B',
    ...
    try {
      ...
      const result = orders.map((o, idx) => {
        ...
        return {
          ...
          buyer:
            ((_a = o.buyerId) === null || _a === void 0
              ? void 0
              : _a.fullName) ||
            ((_b = o.buyerId) === null || _b === void 0 ? void 0 : _b.name) ||
            'Buyer',
          seller:
            ((_c = o.sellerId) === null || _c === void 0
              ? void 0
              : _c.fullName) ||
            ((_d = o.sellerId) === null || _d === void 0 ? void 0 : _d.name) ||
            'Seller',
          item:
            ((_e = o.productId) === null || _e === void 0
              ? void 0
              : _e.title) || 'Collector Item',
          totalPrice:
            ((_f = o.amountDetails) === null || _f === void 0
              ? void 0
              : _f.totalPaid) || 0,
          status: statusMap[o.deliveryStatus] || 'Pending',
          deliveryDate: (
            (_g = o.trackingDetails) === null || _g === void 0
              ? void 0
              : _g.estimatedDelivery
          )
      ...
      const result = disputes.map((d, idx) => {
        ...
        return {
          ...
          openedOn: d.createdAt
            ...
            : '2026-04-22',
          usersInvolved: [
            ((_a = d.userId) === null || _a === void 0
              ? void 0
              : _a.fullName) ||
              ((_b = d.userId) === null || _b === void 0 ? void 0 : _b.name) ||
              'Buyer',
            ((_c = d.reportedUser) === null || _c === void 0
              ? void 0
              : _c.fullName) ||
              ((_d = d.reportedUser) === null || _d === void 0
                ? void 0
                : _d.name) ||
              'Seller',
          ],
  ...
  async getPaymentsData(query) {
    ...
    try {
      ...
      const totalRevenue =
        ((_a = totalRevenueDb[0]) === null || _a === void 0
          ? void 0
          : _a.total) || 0
      if (totalRevenue === 0) {
      ...
      const recentTransactions = orders.map((o, idx) => {
        ...
        return {
          ...
          user:
            ((_a = o.sellerId) === null || _a === void 0
              ? void 0
              : _a.fullName) ||
            ((_b = o.sellerId) === null || _b === void 0 ? void 0 : _b.name) ||
            'Seller',
          type: 'Purchase',
          amount:
            ((_c = o.amountDetails) === null || _c === void 0
              ? void 0
              : _c.totalPaid) || 0,
  ...
  async getBoostedListingsData(query) {
    try {
      const boostedProducts = await product_model_1.Product.find({
        isFeatured: true,
      })
        .limit(20)
        .populate('sellerId', 'name fullName')
  ...
  async getCategoriesData(query) {
    try {
      const rootCategories = await category_model_1.Category.find({
        type: 'category',
      })
  ...
  async getNotificationsData(query) {
    try {
      const dbNotifications = await notification_model_1.Notification.find()
        ...
        .limit(30)
      const unreadCount =
        await notification_model_1.Notification.countDocuments({
          isRead: false,
        })
