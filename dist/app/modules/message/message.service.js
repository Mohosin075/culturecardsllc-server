...
const sendMessageToDB = async (userId, payload) => {
  ...
  const data = {
    ...
    image: (payload === null || payload === void 0 ? void 0 : payload.images)
      ? payload.images[0]
      : null,
    file: (payload === null || payload === void 0 ? void 0 : payload.documents)
      ? payload.documents[0]
      : null,
    sender: userId,
    receiver: receiverId,
  ...
  if (io) {
    io.emit(
      `getMessage::${data === null || data === void 0 ? void 0 : data.chatId}`,
      response,
    )
    io.emit(
      `updateChatList::${data === null || data === void 0 ? void 0 : data.sender}`,
    )
    io.emit(
      `updateChatList::${data === null || data === void 0 ? void 0 : data.receiver}`,
    )
