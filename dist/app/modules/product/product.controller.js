...
const getProductById = (0, catchAsync_1.default)(async (req, res) => {
  const result = await product_service_1.ProductServices.getProductById(
    req.params.id,
  )
  ;(0, sendResponse_1.default)(res, {
    statusCode: http_status_codes_1.StatusCodes.OK,
...
const updateProduct = (0, catchAsync_1.default)(async (req, res) => {
  const result = await product_service_1.ProductServices.updateProduct(
    req.params.id,
    req.body,
  )
  ;(0, sendResponse_1.default)(res, {
...
const deleteProduct = (0, catchAsync_1.default)(async (req, res) => {
  const result = await product_service_1.ProductServices.deleteProduct(
    req.params.id,
  )
  ;(0, sendResponse_1.default)(res, {
    statusCode: http_status_codes_1.StatusCodes.OK,
