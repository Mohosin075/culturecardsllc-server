...
router.post('/', (0, auth_1.default)(user_1.USER_ROLES.SELLER, user_1.USER_ROLES.BUYER), (0, validateRequest_1.default)(product_validation_1.ProductValidations.createProductSchema), product_controller_1.ProductControllers.createProduct);
