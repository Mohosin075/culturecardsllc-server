...
router.post(
  ...
  (0, validateRequest_1.default)(
    trade_validation_1.TradeValidations.createTradeOfferSchema,
  ),
  trade_controller_1.TradeControllers.createTradeOffer,
)
...
router.post(
  '/decline/:id',
  trade_controller_1.TradeControllers.declineTradeOffer,
)
