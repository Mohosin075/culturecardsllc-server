...
const getTradeOffers = (0, catchAsync_1.default)(async (req, res) => {
  ...
  const result = await trade_service_1.TradeServices.getTradeOffers(
    userId,
    type,
  )
  ;(0, sendResponse_1.default)(res, {
...
const acceptTradeOffer = (0, catchAsync_1.default)(async (req, res) => {
  const result = await trade_service_1.TradeServices.acceptTradeOffer(
    req.params.id,
  )
  ;(0, sendResponse_1.default)(res, {
    statusCode: http_status_codes_1.StatusCodes.OK,
...
const declineTradeOffer = (0, catchAsync_1.default)(async (req, res) => {
  const result = await trade_service_1.TradeServices.declineTradeOffer(
    req.params.id,
  )
  ;(0, sendResponse_1.default)(res, {
    statusCode: http_status_codes_1.StatusCodes.OK,
