...
router.post(
  ...
  (0, validateRequest_1.default)(
    favourite_validation_1.FavouriteValidation.toggleFavouriteZodSchema,
  ),
  favourite_controller_1.FavouriteController.toggleFavourite,
)
router.get(
  '/my-favourites',
  (0, auth_1.default)(
  ...
  favourite_controller_1.FavouriteController.getMyFavourites,
)
