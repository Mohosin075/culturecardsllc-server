...
router.patch(
  '/switch-role',
  (0, auth_1.default)(user_1.USER_ROLES.USER, user_1.USER_ROLES.PROFESSIONAL),
  (0, validateRequest_1.default)(user_validation_1.switchRoleSchema),
  user_controller_1.UserController.switchRole,
)
router.get(
  '/profile',
  (0, auth_1.default)(
...
router.patch(
  ...
  user_controller_1.UserController.deactivateProfile,
)
...
router
  ...
  .patch(
    (0, auth_1.default)(user_1.USER_ROLES.ADMIN, user_1.USER_ROLES.SUPER_ADMIN),
    (0, validateRequest_1.default)(user_validation_1.updateUserStatusSchema),
