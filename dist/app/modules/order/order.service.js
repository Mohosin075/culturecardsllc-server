...
const updateOrderJourney = async (orderId, journeyUpdate, deliveryStatus) => {
    ...
    const buyerUserId = (buyerUser === null || buyerUser === void 0 ? void 0 : buyerUser._id) ? buyerUser._id.toString() : order.buyerId.toString();
    ...
    if (chat) {
        ...
        await message_model_1.Message.create({
            ...
            metadata: {
                orderId: order._id.toString(),
                statusLabel: deliveryStatus === 'shipped' ? 'ORDER SHIPPED 🚚' : 'SHIPMENT UPDATE 📦',
