...
const generateAgoraToken = (0, catchAsync_1.default)(async (req, res) => {
  ...
  const result = await auction_service_1.AuctionServices.generateAgoraToken(
    channelName,
    uid,
    role,
  )
...
const createLiveStream = (0, catchAsync_1.default)(async (req, res) => {
  const result = await auction_service_1.AuctionServices.createLiveStream(
    req.body,
  )
  ;(0, sendResponse_1.default)(res, {
...
const createAuctionItem = (0, catchAsync_1.default)(async (req, res) => {
  const result = await auction_service_1.AuctionServices.createAuctionItem(
    req.body,
  )
  ;(0, sendResponse_1.default)(res, {
    statusCode: http_status_codes_1.StatusCodes.CREATED,
...
const placeBidSecure = (0, catchAsync_1.default)(async (req, res) => {
  ...
  const result = await auction_service_1.AuctionServices.placeBidSecure(
    auctionItemId,
    bidderId,
    bidAmount,
  )
