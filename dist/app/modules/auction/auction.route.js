...
router.post(
  ...
  (0, validateRequest_1.default)(
    auction_validation_1.AuctionValidations.createLiveStreamSchema,
  ),
  auction_controller_1.AuctionControllers.createLiveStream,
)
router.get('/streams', auction_controller_1.AuctionControllers.getLiveStreams)
router.post(
  '/item',
  (0, validateRequest_1.default)(
    auction_validation_1.AuctionValidations.createAuctionItemSchema,
  ),
  auction_controller_1.AuctionControllers.createAuctionItem,
)
router.post(
  '/bid',
  (0, validateRequest_1.default)(
    auction_validation_1.AuctionValidations.placeBidSchema,
  ),
  auction_controller_1.AuctionControllers.placeBidSecure,
)
