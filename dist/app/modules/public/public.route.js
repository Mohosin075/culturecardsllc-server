...
router.post('/', (0, auth_1.default)(user_1.USER_ROLES.ADMIN, user_1.USER_ROLES.SUPER_ADMIN), (0, validateRequest_1.default)(public_validation_1.PublicValidation.create), public_controller_1.PublicController.createPublic);
router.get('/:type', public_controller_1.PublicController.getAllPublics);
router.delete('/:id', (0, auth_1.default)(user_1.USER_ROLES.ADMIN, user_1.USER_ROLES.SUPER_ADMIN), public_controller_1.PublicController.deletePublic);
router.patch('/update/:id', (0, auth_1.default)(user_1.USER_ROLES.ADMIN, user_1.USER_ROLES.SUPER_ADMIN), public_controller_1.PublicController.updatePublic);
