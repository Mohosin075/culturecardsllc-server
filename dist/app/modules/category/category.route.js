...
router.get(
  '/popular-categories',
  category_controller_1.CategoryController.getPopularCategories,
)
router.get(
  '/trending-subcategories',
  category_controller_1.CategoryController.getTrendingSubcategories,
)
router
  .route('/')
  ...
  .post(
    ...
    (0, validateRequest_1.default)(category_validation_1.createCategorySchema),
...
router
  ...
  .patch(
    (0, auth_1.default)(user_1.USER_ROLES.ADMIN, user_1.USER_ROLES.SUPER_ADMIN),
    (0, processReqBody_1.fileAndBodyProcessorUsingDiskStorage)(),
    (0, validateRequest_1.default)(category_validation_1.updateCategorySchema),
