...
exports.subscriptionValidation =
  exports.createBillingPortalSchema =
  exports.applyCouponSchema =
  exports.attachPaymentMethodSchema =
  exports.subscriptionAnalyticsSchema =
  exports.bulkUpdatePlansSchema =
  exports.checkTrialEligibilitySchema =
  exports.webhookHeaderSchema =
  exports.planParamsSchema =
  exports.subscriptionParamsSchema =
  exports.getPlansQuerySchema =
  exports.createCheckoutSessionSchema =
  exports.updateSubscriptionSchema =
  exports.createSubscriptionSchema =
  exports.updateSubscriptionPlanSchema =
  exports.createSubscriptionPlanSchema =
    void 0
...
exports.createSubscriptionPlanSchema = zod_1.z.object({
  body: zod_1.z.object({
    ...
    userTypes: zod_1.z
      .array(
        zod_1.z.enum(['user', 'professional', 'admin', 'super_admin'], {
...
exports.bulkUpdatePlansSchema = zod_1.z.object({
  body: zod_1.z.object({
    planIds: zod_1.z
      .array(
        zod_1.z.string().regex(/^[0-9a-fA-F]{24}$/, 'Invalid plan ID format'),
      )
