    ...
    try {
      ...
      const report = {
        ...
        subscriptions: {
          ...
          active: await subscription_model_1.Subscription.countDocuments({
            status: 'active',
          }),
          trialing: await subscription_model_1.Subscription.countDocuments({
            status: 'trialing',
          }),
          pastDue: await subscription_model_1.Subscription.countDocuments({
            status: 'past_due',
          }),
          canceled: await subscription_model_1.Subscription.countDocuments({
            status: 'canceled',
          }),
        },
        newSubscriptions:
          await subscription_model_1.Subscription.countDocuments({
        ...
        plans: {
          total:
            await subscription_plan_model_1.SubscriptionPlan.countDocuments(),
          active:
            await subscription_plan_model_1.SubscriptionPlan.countDocuments({
              isActive: true,
            }),
