  ...
  if (hasSections) {
    ...
    bodyHtml = content.replace(
      ...
      (_match, attrs, innerText) => {
        ...
        return `<section id="${id}" class="legal-section"><div class="section-header"><span class="section-num">${num}</span><h2${cleanAttrs} class="section-title">${innerText}</h2></div>`
      },
    )
